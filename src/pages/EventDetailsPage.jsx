...
function EventDetailsPage() {
  ...
  const registrations =
    typeof window !== "undefined"
      ? JSON.parse(localStorage.getItem(REGISTRATIONS_STORAGE_KEY) || "[]")
      : [];
  const attendees = registrations.filter((item) => item.event_id === eventId)
    .length;
          ...
          <div className="mt-8 mb-24 px-6 sm:px-0">
            ...
            <div className="mt-8 flex gap-2 items-center ">
              ...
              <p className="text-gray">
                {attendees} {attendees === 1 ? "person" : "people"} RSVP'd
              </p>
            </div>
          </div>
        </article>
